...
while opcao !=6:
    ...
    if opcao ==1:
        ...
        quantidade = frances + quantidade
        valor_frances = frances + (quantidade * 1.04)
    elif opcao ==2:
        quantidade = int(input("Digite a quantidade desejada de Pão Integral: "))
        quantidade = integral + quantidade
        valor_integral = integral * 1.04
    elif opcao ==3:
        doce_liso = int(input("Digite a quantidade desejada de Pão Doce Liso: "))
        valor_doce_liso = doce_liso * 1.08
    elif opcao ==4:
        doce_farofa = int(input("Digite a quantidade desejada Pão Doce Farofa: "))
        valor_doce_farofa = doce_farofa * 1.11
    elif opcao ==5:
        forma = int(input("Digite a quantidade desejada de Pão De Forma "))
...
if (integral >0):
    print (f"-Pão Integral - Quantidade {quantidade} | valor R$ {valor_integral::.2f}")
if (doce_liso >0):
    print (f"-Pão Doce Liso - Quantidade {quantidade} | valor R$ {valor_doce_liso:.2f}")
if (doce_farofa >0):
    print (f"-Pão Doce Liso - Quantidade {quantidade} | valor R$ {valor_doce_liso:.2f}")
if (forma >0):
    print (f"-Pão De Forma - Quantidade {quantidade} | valor R$ {valor_forma:.2f}")
